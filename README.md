...
dotnet 5 web api with version, documentation through swagger, localization, claim based jwt token security, feature toggling, centralized logging/exception-handling, etc.
