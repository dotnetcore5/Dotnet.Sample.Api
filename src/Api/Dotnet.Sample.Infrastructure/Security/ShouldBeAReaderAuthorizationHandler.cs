...
{
    internal class ShouldBeAReaderRequirement : IAuthorizationRequirement
    {
    }

    internal class ShouldBeAReaderAuthorizationHandler : AuthorizationHandler<ShouldBeAReaderRequirement>
    {
