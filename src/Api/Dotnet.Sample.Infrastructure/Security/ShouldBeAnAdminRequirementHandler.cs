...
{
    internal class ShouldBeAnAdminRequirement : IAuthorizationRequirement
    {
    }

    internal class ShouldBeAnAdminRequirementHandler : AuthorizationHandler<ShouldBeAnAdminRequirement>
    {
